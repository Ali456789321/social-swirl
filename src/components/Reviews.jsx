...
const Reviews = () => {
    return (
        <div className='w-10/12 max-sm:w-full m-auto'>
            ...
            {/* <div className='hidden max-sm:block mx-2'>
                <Swiper
                    slidesPerView={1}
                    spaceBetween={30}
                    loop={true}
                ...
                >

                    {
                        review.map((item) => (
                            <>
                                <SwiperSlide>
                                    <div className='text-center bg-white px-10 py-3 rounded-xl shadow-md shadow-black my-5' key={item.id}>
                                        <h1>
                                          "{item.reviews}"
                                        </h1>
                                        <hr className='py-3'/>
                                        <h1 className='font-semibold text-2xl'>
                                            <span className='bg-gradient-to-r from-social_left to-social_right bg-clip-text text-transparent'>Bundu Khan/</span>
