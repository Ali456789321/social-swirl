...
const Intern = () => {
    ...
    const filterData = 
    jobs.filter(ele => ele.type === "internship")
    ...
    return (
        <>
            <Adminnav />
            <h1 className='text-5xl text-center font-bold bg-gradient-to-r from-social_right to-social_left bg-clip-text text-transparent mt-20 mb-10'>Internship Table</h1>
