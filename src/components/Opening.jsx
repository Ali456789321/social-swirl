    ...
    <>
     <div className='w-10/12 m-auto py-40'>
        ...
        <div className='grid grid-cols-4 mt-10 max-sm:grid-cols-1'>
            <div className='text-center cursor-pointer hover:origin-top certificate w-64 mt-5 max-sm:mt-10 max-sm:w-full max-sm:m-auto bg-white py-11 px-5 rounded-xl'>
